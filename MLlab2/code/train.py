...
if __name__ == '__main__':
    ...
    model_name_or_path = "/root/autodl-tmp/distilGpt2"  # 你的本地路径
    model = GPTSingleHead(model_name_or_path, max_seq_length=args.max_seq_length)
    ...
    model_trainer = ModelTrainer(model,
                                 ...
                                 optimizer_params={'lr': args.lr, 'eps': 3e-5, 'correct_bias': False},
